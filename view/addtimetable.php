  ...
  <div>
		...
		<div>
			<div class="container bg-light col-5">
				<form class="form-horizontal" name="myform" role="form" method="post">
					<h3>Add Timetable</h3>
						<div class="form-group">
							<label for="Name" class="col-sm-3 control-label">Day</label>
								<div class="col-sm-8">
				...
				<div class="form-group">
                    <label for="Name" class="col-sm-3 control-label">Hour1</label>
                    <div class="col-sm-8">
                        <input type="text" id="h1" class="form-control" name="h1" required autofocus>
                    </div>
                </div>
				<div class="form-group">
                    <label for="Name" class="col-sm-3 control-label">Hour2</label>
                    <div class="col-sm-8">
                        <input type="text" id="h2" class="form-control" name="h2" required autofocus>
                    </div>
                </div>
				<div class="form-group">
                    <label for="Name" class="col-sm-3 control-label">Hour3</label>
                    <div class="col-sm-8">
                        <input type="text" id="h3" class="form-control" name="h3" required autofocus>
                    </div>
                </div>
				<div class="form-group">
                    <label for="Name" class="col-sm-3 control-label">Hour4</label>
                    <div class="col-sm-8">
                        <input type="text" id="h4" class="form-control" name="h4" required autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Adminid</label>
                    <div class="col-sm-8">
				...
				<input type="submit" class="btn btn-primary ml-5" name="addtimtable" value="Add">
                </div>
            </form>
			<?php
				if(isset($_POST['addtimtable']))
				{
